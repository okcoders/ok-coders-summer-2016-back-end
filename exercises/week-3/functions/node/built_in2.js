...
if (Math.abs(absX1) == 100) {
    console.log("Test 1 passed")
} else {
    console.log("Test 1 failed *")
}

if (Math.abs(absY1) == 100) {
...
if (Math.floor(floorX3) == 3) {
    console.log("Test 4 passed")
} else {
    console.log("Test 4 failed *")
}

if (Math.ceil(ceilingY3) == 4) {
...
if (charAtX4.charAt(6) == 'W') {
    console.log("Test 6 passed")
} else {
    console.log("Test 6 failed *")
}

if (charAtY4.charAt(1) == 'u') {
...
if (indexOfX7.indexOf(substring) == 6) {
